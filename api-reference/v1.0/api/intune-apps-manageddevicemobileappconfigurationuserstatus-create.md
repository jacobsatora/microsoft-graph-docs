...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-apps-manageddevicemobileappconfigurationuserstatus-create-create-manageddevicemobileappconfigurationuserstatus-cli-snippets.md)]
