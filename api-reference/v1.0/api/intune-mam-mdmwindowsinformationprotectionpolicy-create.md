...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-mam-mdmwindowsinformationprotectionpolicy-create-create-mdmwindowsinformationprotectionpolicy-cli-snippets.md)]
