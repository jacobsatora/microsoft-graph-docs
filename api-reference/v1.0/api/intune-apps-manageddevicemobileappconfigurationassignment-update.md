...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-apps-manageddevicemobileappconfigurationassignment-update-update-manageddevicemobileappconfigurationassignment-cli-snippets.md)]
