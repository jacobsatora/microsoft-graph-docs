...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-rbac-deviceandappmanagementroledefinition-create-create-deviceandappmanagementroledefinition-cli-snippets.md)]
