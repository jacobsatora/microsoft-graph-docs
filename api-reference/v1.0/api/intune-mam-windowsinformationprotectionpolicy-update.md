...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-mam-windowsinformationprotectionpolicy-update-update-windowsinformationprotectionpolicy-cli-snippets.md)]
