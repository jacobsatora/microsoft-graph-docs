...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-onboarding-enrollmentconfigurationassignment-create-create-enrollmentconfigurationassignment-cli-snippets.md)]
