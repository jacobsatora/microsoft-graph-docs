...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-deviceconfig-deviceconfigurationdevicestatesummary-update-update-deviceconfigurationdevicestatesummary-cli-snippets.md)]
