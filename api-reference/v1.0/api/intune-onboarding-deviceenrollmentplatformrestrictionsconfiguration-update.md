...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-onboarding-deviceenrollmentplatformrestrictionsconfiguration-update-update-deviceenrollmentplatformrestrictionsconfiguration-cli-snippets.md)]
