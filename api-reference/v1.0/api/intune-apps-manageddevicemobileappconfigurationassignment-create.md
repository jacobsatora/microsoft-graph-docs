...
# [CLI](#tab/cli)
[!INCLUDE [sample-code](../includes/snippets/cli/intune-apps-manageddevicemobileappconfigurationassignment-create-create-manageddevicemobileappconfigurationassignment-cli-snippets.md)]
