...
| Display name | Manage all access reviews | Manage all access reviews that user can access |
...
| Display name | Manage access reviews for group and app memberships | Manage access reviews for group and app memberships |
...
| Display name | Read all acronyms | Read all acronyms that the user can access |
...
| Display name | Read all administrative units | Read administrative units |
...
| Display name | Read and write all administrative units | Read and write administrative units |
...
| Display name | Read all terms of use agreements | Read all terms of use agreements |
...
| Display name | Read and write all terms of use agreements | Read and write all terms of use agreements |
...
| Display name | - | Read user terms of use acceptance statuses |
...
| Display name | Read all terms of use acceptance statuses | Read terms of use acceptance statuses that user can access |
...
| Display name | - | Read user activity statistics |
...
| Display name | Read API connectors for authentication flows | Read API connectors for authentication flows |
...
| Display name | Read and write API connectors for authentication flows | Read and write API connectors for authentication flows |
...
| Display name | Read all app catalogs | Read all app catalogs |
...
| Display name | Read and write to all app catalogs | Read and write to all app catalogs |
...
| Display name | - | Submit application packages to the catalog and cancel pending submissions |
...
| Display name | Read all applications | Read applications |
...
| Display name | Read and write all applications | Read and write all applications |
...
| Display name | Read and write the remote desktop security configuration for all apps | Read and write the remote desktop security configuration for apps |
...
| Display name | Manage app permission grants and app role assignments | Manage app permission grants and app role assignments |
...
| Display name | Read attack simulation data of an organization | Read attack simulation data of an organization |
...
| Display name | Read, create, and update all attack simulation data of an organization | Read, create, and update attack simulation data of an organization |
...
| Display name | Read all audit log data | Read audit log data |
...
| Display name | Read all authentication context information | Read all authentication context information |
...
| Display name | Read and write all authentication context information | Read and write all authentication context information |
...
| Display name | Read and write application billing configuration | Read and write application billing configuration |
...
| Display name | - | Read BitLocker keys |
...
| Display name | - | Read BitLocker keys basic information |
...
| Display name | Read all Bookings related resources. | Read bookings information |
...
| Display name | Read and write all Bookings related resources. | Read and write booking appointments |
...
| Display name | Read all bookmarks | Read all bookmarks that the user can access |
...
| Display name | Read all browser site lists for your organization | Read browser site lists for your organization |
...
| Display name | Read and write all browser site lists for your organization | Read and write browser site lists for your organization |
...
| Display name | - | Read business scenario configurations |
...
| Display name | Read all business scenario configurations this app creates or owns | Read business scenario configurations this app creates or owns |
...
| Display name | - | Read and write business scenario configurations |
...
| Display name | Read and write all business scenario configurations this app creates or owns | Read and write business scenario configurations this app creates or owns |
...
| Display name | Read data for all business scenarios this app creates or owns | Read all data for business scenarios this app creates or owns |
...
| Display name | Read and write data for all business scenarios this app creates or owns | Read and write all data for business scenarios this app creates or owns |
...
| Display name | Read calendars in all mailboxes | Read user calendars  |
...
| Display name | - | Read user and shared calendars |
...
| Display name | - | Read basic details of user calendars |
...
| Display name | Read basic details of calendars in all mailboxes  | - |
...
| Display name | Read and write calendars in all mailboxes | Have full access to user calendars  |
...
| Display name | - | Read and write user and shared calendars |
...
| Display name | Create channels | Create channels |
...
| Display name | Delete channels | Delete channels |
...
| Display name | Read the names and descriptions  of all channels | Read the names and descriptions of channels |
...
| Display name | Read the members of all channels | Read the members of channels |
...
| Display name | Add and remove members from all channels | Add and remove members from channels |
...
| Display name | - | Edit user's channel messages |
...
| Display name | Read all channel messages | Read user channel messages |
...
| Display name | - | Read and write user channel messages |
...
| Display name | - | Send channel messages |
...
| Display name | Read the names, descriptions, and settings of all channels | Read the names, descriptions, and settings of channels |
...
| Display name | Read and write the names, descriptions, and settings of all channels | Read and write the names, descriptions, and settings of channels |
...
| Display name | Create chats | Create chats |
...
| Display name | Delete and recover deleted chats | Delete and recover deleted chats |
...
| Display name | - | Read user chat messages |
...
| Display name | - | Read names and members of user chat threads |
...
| Display name | - | Read and write user chat messages |
...
| Display name | - | Read the members of chats |
...
| Display name | Read the members of all chats where the associated Teams application is installed. | - |
...
| Display name | - | Add and remove members from chats |
...
| Display name | - | Send user chat messages |
...
| Display name | Read all discovered cloud applications data | Read discovered cloud applications data |
...
| Display name | Read Cloud PCs | Read Cloud PCs |
...
| Display name | Read and write Cloud PCs | Read and write Cloud PCs |
...
| Display name | Read all consent requests | Read consent requests |
...
| Display name | Read and write all consent requests | Read and write consent requests |
...
| Display name | Read contacts in all mailboxes | Read user contacts  |
...
| Display name | - | Read user and shared contacts |
...
| Display name | Read and write contacts in all mailboxes | Have full access to user contacts  |
...
| Display name | - | Read and write user and shared contacts |
...
| Display name | Read cross-tenant basic information | Read cross-tenant basic information |
...
| Display name | - | Read shared cross-tenant user profile and export data |
...
| Display name | Read all shared cross-tenant user profiles and export their data | Read all shared cross-tenant user profiles and export their data |
...
| Display name | - | Read shared cross-tenant user profile and export or delete data |
...
| Display name | Read all shared cross-tenant user profiles and export or delete their data | Read all shared cross-tenant user profiles and export or delete their data |
...
| Display name | Read all custom authentication extensions | Read your oganization's custom authentication extensions |
...
| Display name | Read and write all custom authentication extensions | Read and write your organization's custom authentication extensions |
...
| Display name | Read custom security attribute assignments | Read custom security attribute assignments |
...
| Display name | Read and write custom security attribute assignments | Read and write custom security attribute assignments |
...
| Display name | Read custom security attribute definitions | Read custom security attribute definitions |
...
| Display name | Read and write custom security attribute definitions | Read and write custom security attribute definitions |
...
| Display name | Read Delegated Admin relationships with customers | Read Delegated Admin relationships with customers |
...
| Display name | Manage Delegated Admin relationships with customers | Manage Delegated Admin relationships with customers |
...
| Display name | Manage all delegated permission grants | Manage all delegated permission grants |
...
| Display name | - | Communicate with user devices |
...
| Display name | - | Read user devices |
...
| Display name | Read all devices | Read all devices |
...
| Display name | Read device local credential passwords | Read device local credential passwords |
...
| Display name | Read device local credential properties | Read device local credential properties |
...
| Display name | Read Microsoft Intune apps | Read Microsoft Intune apps |
...
| Display name | Read and write Microsoft Intune apps | Read and write Microsoft Intune apps |
...
| Display name | Read Microsoft Intune device configuration and policies | Read Microsoft Intune Device Configuration and Policies |
...
| Display name | Read and write Microsoft Intune device configuration and policies | Read and write Microsoft Intune Device Configuration and Policies |
...
| Display name | Perform user-impacting remote actions on Microsoft Intune devices | Perform user-impacting remote actions on Microsoft Intune devices |
...
| Display name | Read Microsoft Intune devices | Read Microsoft Intune devices |
...
| Display name | Read and write Microsoft Intune devices | Read and write Microsoft Intune devices |
...
| Display name | Read Microsoft Intune RBAC settings | Read Microsoft Intune RBAC settings |
...
| Display name | Read and write Microsoft Intune RBAC settings | Read and write Microsoft Intune RBAC settings |
...
| Display name | Read Microsoft Intune configuration | Read Microsoft Intune configuration |
...
| Display name | Read and write Microsoft Intune configuration | Read and write Microsoft Intune configuration |
...
| Display name | - | Access directory as the signed in user |
...
| Display name | Read directory data | Read directory data |
...
| Display name | Read and write directory data | Read and write directory data |
...
| Display name | Manage restricted resources in the directory | Manage restricted resources in the directory |
...
| Display name | Read all Azure AD recommendations | Read Azure AD recommendations |
...
| Display name | Read and update all Azure AD recommendations | Read and update Azure AD recommendations |
...
| Display name | Read domains | Read domains. |
...
| Display name | Read and write domains | Read and write domains |
...
| Display name | - | Access mailboxes via Exchange ActiveSync |
...
| Display name | Read all eDiscovery objects | Read all eDiscovery objects |
...
| Display name | Read and write all eDiscovery objects | Read and write all eDiscovery objects |
...
| Display name | - | Read users' class assignments and their grades |
...
| Display name | Read all class assignments with grades | - |
...
| Display name | - | Read users' class assignments without grades |
...
| Display name | Read all class assignments without grades | - |
...
| Display name | - | Read and write users' class assignments and their grades |
...
| Display name | Create, read, update and delete all class assignments with grades | - |
...
| Display name | - | Read and write users' class assignments without grades |
...
| Display name | Create, read, update and delete all class assignments without grades | - |
...
| Display name | - | Read the user's class modules and resources |
...
| Display name | Read all class modules and resources | - |
...
| Display name | - | Read and write your class modules and resources |
...
| Display name | Read and write all class modules and resources | - |
...
| Display name | - | Read users' view of the roster |
...
| Display name | - | Read a limited subset of users' view of the roster |
...
| Display name | - | Read and write users' view of the roster |
...
| Display name | - | View users' email address |
...
| Display name | Read all entitlement management resources | Read all entitlement management resources |
...
| Display name | Read and write all entitlement management resources | Read and write entitlement management resources |
...
| Display name | - | Read and write entitlement management resources related to self-service operations |
...
| Display name | Read all authentication event listeners | Read your organization's authentication event listeners |
...
| Display name | Read and write all authentication event listeners | Read and write your organization's authentication event listeners |
...
| Display name | - | Access mailboxes as the signed-in user via Exchange Web Services |
...
| Display name | Read all external connections | Read all external connections |
...
| Display name | Read and write all external connections | Read and write all external connections |
...
| Display name | Read and write external connections | Read and write external connections |
...
| Display name | Read all external items | Read items in external datasets |
...
| Display name | Read and write items in external datasets | Read and write all external items |
...
| Display name | Read and write external items | Read and write external items |
...
| Display name | - | Read your family info |
...
| Display name | Read files in all site collections | Read all files that user can access |
...
| Display name | - | Read files that the user selects (preview) |
...
| Display name | - | Have full access to user files |
...
| Display name | Read and write files in all site collections | Have full access to all files user can access |
...
| Display name | - | Have full access to the application's folder (preview) |
...
| Display name | - | Read and write files that the user selects (preview) |
...
| Display name | - | Read and write financials data |
...
| Display name | Read all groups | Read all groups |
...
| Display name | Read and write all groups | Read and write all groups |
...
| Display name | Read all group memberships | Read group memberships |
...
| Display name | Read and write all group memberships | Read and write group memberships |
...
| Display name | Read identity providers | Read identity providers |
...
| Display name | Read and write identity providers | Read and write identity providers |
...
| Display name | Read all identity risk event information | Read identity risk event information |
...
| Display name | Read and write all risk detection information | Read and write risk event information |
...
| Display name | Read all identity risky service principal information | Read all identity risky service principal information |
...
| Display name | Read and write all identity risky service principal information | Read and write all identity risky service principal information |
...
| Display name | Read all identity risky user information | Read identity risky user information |
...
| Display name | Read and write all risky user information | Read and write risky user information |
...
| Display name | Read all identity user flows | Read all identity user flows |
...
| Display name | Read and write all identity user flows | Read and write all identity user flows |
...
| Display name | - | Read and write access to mailboxes via IMAP. |
...
| Display name | View basic service and resource information | Read basic Industry Data service and resource definitions |
...
| Display name | View data connector definitions | View data connector definitions |
...
| Display name | Manage data connector definitions | Manage data connector definitions |
...
| Display name | Upload files to a data connector | Upload files to a data connector |
...
| Display name | View inbound flow definitions | View inbound flow definitions |
...
| Display name | Manage inbound flow definitions | Manage inbound flow definitions |
...
| Display name | View reference definitions | View reference definitions |
...
| Display name | View current and previous runs | View current and previous runs |
...
| Display name | View source system definitions | View source system definitions |
...
| Display name | Manage source system definitions | Manage source system definitions |
...
| Display name | Read time period definitions | Read time period definitions |
...
| Display name | Manage time period definitions | Manage time period definitions |
...
| Display name | - | Read configurations for protecting organizational data applicable to the user |
...
| Display name | Read all configurations for protecting organizational data applicable to users | - |
...
| Display name | Sign digests for data | - |
...
| Display name | Create protected content | - |
...
| Display name | - | Read user sensitivity labels and label policies. |
...
| Display name | - | Read user's assignments |
...
| Display name | Read all assignments | - |
...
| Display name | Read all learning content | Read learning content |
...
| Display name | Manage all learning content | Manage learning content |
...
| Display name | - | Read learning provider |
...
| Display name | - | Manage learning provider |
...
| Display name | - | Read user's self-initiated courses |
...
| Display name | Read all self-initiated courses | - |
...
| Display name | Read and write all self-initiated courses | - |
...
| Display name | Manage all license assignments | Manage all license assignments |
...
| Display name | Read all lifecycle workflows resources | Read all lifecycle workflows resources |
...
| Display name | Read and write all lifecycle workflows resources | Read and write all lifecycle workflows resources |
...
| Display name | Read mail in all mailboxes | Read user mail  |
...
| Display name | - | Read user and shared mail |
...
| Display name | Read basic mail in all mailboxes | Read user basic mail |
...
| Display name | - | Read user and shared basic mail |
...
| Display name | Read and write mail in all mailboxes | Read and write access to user mail  |
...
| Display name | - | Read and write user and shared mail |
...
| Display name | Send mail as any user | Send mail as a user  |
...
| Display name | - | Send mail on behalf of others |
...
| Display name | Read all user mailbox settings | Read user mailbox settings |
...
| Display name | Read and write all user mailbox settings | Read and write user mailbox settings |
...
| Display name | - | Read all managed tenant information |
...
| Display name | - | Read and write all managed tenant information |
...
| Display name | Read all hidden memberships | Read hidden memberships |
...
| Display name | Read properties of all branches for network access | Read properties of branches for network access |
...
| Display name | Read and write properties of all branches for network access | Read and write properties of branches for network access |
...
| Display name | Read all security and routing policies for network access | Read security and routing policies for network access |
...
| Display name | Read and write all security and routing policies for network access | Read and write security and routing policies for network access |
...
| Display name | - | Create user OneNote notebooks |
...
| Display name | - | Read user OneNote notebooks |
...
| Display name | Read all OneNote notebooks | Read all OneNote notebooks that user can access |
...
| Display name | - | Read and write user OneNote notebooks |
...
| Display name | Read and write all OneNote notebooks | Read and write all OneNote notebooks that user can access |
...
| Display name | - | Limited notebook access (deprecated) |
...
| Display name | - | Deliver and manage user notifications for this app |
...
| Display name | - | Maintain access to data you have given it access to |
...
| Display name | Read online meeting artifacts | Read user's online meeting artifacts |
...
| Display name | Read all recordings of online meetings. | Read all recordings of online meetings. |
...
| Display name | - | Read user's online meetings |
...
| Display name | - | Read and create user's online meetings |
...
| Display name | Read all transcripts of online meetings. | Read all transcripts of online meetings.  |
...
| Display name | Read all on-premises directory synchronization information | Read all on-premises directory synchronization information |
...
| Display name | Read and write all on-premises directory synchronization information | Read and write all on-premises directory synchronization information |
...
| Display name | Manage on-premises published resources | Manage on-premises published resources |
...
| Display name | Read organization information | Read organization information |
...
| Display name | Read and write organization information | Read and write organization information |
...
| Display name | Read organizational contacts | Read organizational contacts |
...
| Display name | Read organization-wide apps and services settings | Read organization-wide apps and services settings |
...
| Display name | Read and write organization-wide apps and services settings | Read and write organization-wide apps and services settings |
...
| Display name | Read organization-wide Dynamics customer voice settings | Read organization-wide Dynamics customer voice settings |
...
| Display name | Read and write organization-wide Dynamics customer voice settings | Read and write organization-wide Dynamics customer voice settings |
...
| Display name | Read organization-wide Microsoft Forms settings | Read organization-wide Microsoft Forms settings |
...
| Display name | Read and write organization-wide Microsoft Forms settings | Read and write organization-wide Microsoft Forms settings |
...
| Display name | Read organization-wide Microsoft To Do settings | Read organization-wide Microsoft To Do settings |
...
| Display name | Read and write organization-wide Microsoft To Do settings | Read and write organization-wide Microsoft To Do settings |
...
| Display name | - | Read users' relevant people lists |
...
| Display name | Read all users' relevant people lists | Read all users' relevant people lists |
...
| Display name | Read all tenant-wide people settings | Read tenant-wide people settings |
...
| Display name | Read and write all tenant-wide people settings | Read and write tenant-wide people settings |
...
| Display name | Read all company places | Read all company places |
...
| Display name | - | Read and write organization places |
...
| Display name | Read your organization's policies | Read your organization's policies |
...
| Display name | Read your organization's conditional access policies | Read your organization's conditional access policies |
...
| Display name | Read consent and permission grant policies | Read consent and permission grant policies |
...
| Display name | Read and write your organization's directory access review default policy | Read and write your organization's directory access review default policy |
...
| Display name | Read and write your organization's application configuration policies | Read and write your organization's application configuration policies |
...
| Display name | Read and write authentication flow policies | Read and write authentication flow policies |
...
| Display name | Read and write all authentication method policies  | Read and write authentication method policies |
...
| Display name | Read and write your organization's authorization policy | Read and write your organization's authorization policy |
...
| Display name | Read and write your organization's conditional access policies | Read and write your organization's conditional access policies |
...
| Display name | Read and write your organization's consent request policy | Read and write consent request policy |
...
| Display name | Read and write your organization's cross tenant access policies | Read and write your organization's cross tenant access policies |
...
| Display name | Read and write your organization's external identities policy | Read and write your organization's external identities policy |
...
| Display name | Read and write feature rollout policies | Read and write your organization's feature rollout policies |
...
| Display name | - | Read and write your organization's mobility management policies |
...
| Display name | Manage consent and permission grant policies | Manage consent and permission grant policies |
...
| Display name | Read and write your organization's security defaults policy | Read and write your organization's security defaults policy |
...
| Display name | Read and write your organization's trust framework policies | Read and write your organization's trust framework policies |
...
| Display name | - | Read and write access to mailboxes via POP. |
...
| Display name | - | Read user's presence information |
...
| Display name | - | Read presence information of all users in your organization |
...
| Display name | - | Read and write a user's presence information |
...
| Display name | - | Read print connectors |
...
| Display name | - | Read and write print connectors |
...
| Display name | - | Register printers   |
...
| Display name | - | Register, read, update, and unregister printers |
...
| Display name | Read printers | Read printers |
...
| Display name | Read and update printers | Read and update printers |
...
| Display name | - | Read printer shares |
...
| Display name | - | Read basic information about printer shares |
...
| Display name | - | Read and write printer shares |
...
| Display name | - | Create print jobs |
...
| Display name | - | Read user's print jobs |
...
| Display name | Read print jobs | Read print jobs |
...
| Display name | - | Read basic information of user's print jobs |
...
| Display name | Read basic information for print jobs | Read basic information of print jobs |
...
| Display name | - | Read and write user's print jobs |
...
| Display name | Read and write print jobs | Read and write print jobs |
...
| Display name | - | Read and write basic information of user's print jobs |
...
| Display name | Read and write basic information for print jobs | Read and write basic information of print jobs |
...
| Display name | Read tenant-wide print settings | Read tenant-wide print settings |
...
| Display name | - | Read and write tenant-wide print settings |
...
| Display name | Read privileged access to Azure AD roles | Read privileged access to Azure AD |
...
| Display name | Read privileged access to Azure AD groups | Read privileged access to Azure AD groups |
...
| Display name | Read privileged access to Azure resources | Read privileged access to Azure resources |
...
| Display name | Read and write privileged access to Azure AD roles | Read and write privileged access to Azure AD |
...
| Display name | Read and write privileged access to Azure AD groups | Read and write privileged access to Azure AD groups |
...
| Display name | Read and write privileged access to Azure resources | Read and write privileged access to Azure resources |
...
| Display name | Read assignment schedules for access to Azure AD groups | Read assignment schedules for access to Azure AD groups |
...
| Display name | Read, create, and delete assignment schedules for access to Azure AD groups | Read, create, and delete assignment schedules for access to Azure AD groups |
...
| Display name | Read eligibility schedules for access to Azure AD groups | Read eligibility schedules for access to Azure AD groups |
...
| Display name | Read, create, and delete eligibility schedules for access to Azure AD groups | Read, create, and delete eligibility schedules for access to Azure AD groups |
...
| Display name | - | View users' basic profile |
...
| Display name | Read all programs | Read all programs that user can access |
...
| Display name | Manage all programs | Manage all programs that user can access |
...
| Display name | Read all Question and Answers  | Read all Questions and Answers that the user can access. |
...
| Display name | Read Records Management configuration, labels and policies | Read Records Management configuration, labels, and policies |
...
| Display name | Read and write Records Management configuration, labels and policies | Read and write Records Management configuration, labels, and policies |
...
| Display name | Read all usage reports | Read all usage reports |
...
| Display name | Read all admin report settings | Read admin report settings |
...
| Display name | Read and write all admin report settings | Read and write admin report settings |
...
| Display name | Read all active role assignments and role schedules for your company's directory | Read all active role assignments for your company's directory |
...
| Display name | Read, update, and delete all policies for privileged role assignments of your company's directory | Read, update, and delete all active role assignments for your company's directory |
...
| Display name | Read all eligible role assignments and role schedules for your company's directory | Read all eligible role assignments for your company's directory |
...
| Display name | Read, update, and delete all eligible role assignments and schedules for your company's directory | Read, update, and delete  all eligible role assignments for your company's directory |
...
| Display name | Read role management data for all RBAC providers | Read role management data for all RBAC providers |
...
| Display name | Read Cloud PC RBAC settings | Read Cloud PC RBAC settings |
...
| Display name | Read all directory RBAC settings | Read directory RBAC settings |
...
| Display name | Read Exchange Online RBAC configuration | Read Exchange Online RBAC configuration |
...
| Display name | Read and write all Cloud PC RBAC settings | Read and write Cloud PC RBAC settings |
...
| Display name | Read and write all directory RBAC settings | Read and write directory RBAC settings |
...
| Display name | Read and write Exchange Online RBAC configuration | Read and write Exchange Online RBAC configuration |
...
| Display name | Read all alert data for your company's directory | Read all alert data for your company's directory |
...
| Display name | Read all alert data, configure alerts, and take actions on all alerts for your company's directory | Read all alert data, configure alerts, and take actions on all alerts for your company's directory |
...
| Display name | Read all policies in PIM for Groups | Read all policies in PIM for Groups |
...
| Display name | Read all policies for privileged role assignments of your company's directory | Read all policies for privileged role assignments of your company's directory |
...
| Display name | Read, update, and delete all policies in PIM for Groups | Read, update, and delete all policies in PIM for Groups |
...
| Display name | Read, update, and delete all policies for privileged role assignments of your company's directory | Read, update, and delete all policies for privileged role assignments of your company's directory |
...
| Display name | Read all schedule items | Read user schedule items |
...
| Display name | Read and write all schedule items | Read and write user schedule items |
...
| Display name | Read your organization's search configuration | Read your organization's search configuration |
...
| Display name | Read and write your organization's search configuration | Read and write your organization's search configuration |
...
| Display name | Read your organization's security actions | Read your organization's security actions |
...
| Display name | Read and update your organization's security actions | Read and update your organization's security actions |
...
| Display name | Read all security alerts | Read all security alerts |
...
| Display name | Read and write to all security alerts | Read and write to all security alerts |
...
| Display name | Read metadata and detection details for all emails in your organization | Read metadata and detection details for emails in your organization |
...
| Display name | Read metadata, detection details, and execute remediation actions on all emails in your organization | Read metadata, detection details, and execute remediation actions on emails in your organization |
...
| Display name | Read your organization's security events | Read your organization's security events |
...
| Display name | Read and update your organization's security events | Read and update your organization's security events |
...
| Display name | Read all security incidents | Read incidents |
...
| Display name | Read and write to all security incidents | Read and write to incidents |
...
| Display name | Read service health | Read service health |
...
| Display name | Read service messages | Read service announcement messages |
...
| Display name | - | Update user status on service announcement messages |
...
| Display name | Read service principal endpoints | Read service principal endpoints |
...
| Display name | Read and update service principal endpoints | Read and update service principal endpoints |
...
| Display name | Read SharePoint and OneDrive tenant settings | Read SharePoint and OneDrive tenant settings |
...
| Display name | Read and change SharePoint and OneDrive tenant settings | Read and change SharePoint and OneDrive tenant settings |
...
| Display name | - | Read short notes of the signed-in user |
...
| Display name | - | Read, create, edit, and delete short notes of the signed-in user |
...
| Display name | Have full control of all site collections | Have full control of all site collections |
...
| Display name | Create, edit, and delete items and lists in all site collections | Create, edit, and delete items and lists in all site collections |
...
| Display name | Read items in all site collections  | Read items in all site collections |
...
| Display name | Read and write items in all site collections | Edit or delete items in all site collections |
...
| Display name | - | Send emails from mailboxes using SMTP AUTH. |
...
| Display name | Read all subject rights requests | Read subject rights requests |
...
| Display name | Read and write all subject rights requests | Read and write subject rights requests |
...
| Display name | - | Read all webhook subscriptions  |
...
| Display name | Read all Azure AD synchronization data.  | Read all Azure AD synchronization data |
...
| Display name | Read and write all Azure AD synchronization data.  | Read and write all Azure AD synchronization data |
...
| Display name | Upload user data to the identity synchronization service | Upload user data to the identity synchronization service |
...
| Display name | - | Read user's tasks and task lists |
...
| Display name | Read all users' tasks and tasklist | - |
...
| Display name | - | Read user and shared tasks |
...
| Display name | - | Create, read, update, and delete user's tasks and task lists |
...
| Display name | - | Read and write user and shared tasks |
...
| Display name | Create teams | Create teams |
...
| Display name | Get a list of all teams | Read the names and descriptions of teams |
...
| Display name | Read the members of all teams | Read the members of teams |
...
| Display name | Add and remove members from all teams | Add and remove members from teams |
...
| Display name | Add and remove members with non-owner role for all teams | Add and remove members with non-owner role for all teams |
...
| Display name | - | Read user's teamwork activity feed |
...
| Display name | Send a teamwork activity to any user | Send a teamwork activity as the user |
...
| Display name | - | Read installed Teams apps in chats |
...
| Display name | - | Read installed Teams apps in teams |
...
| Display name | - | Read user's installed Teams apps |
...
| Display name | - | Manage installed Teams apps in chats |
...
| Display name | - | Manage installed Teams apps in teams |
...
| Display name | - | Allow the Teams app to manage itself and its permission grants in chats |
...
| Display name | - | Allow the Teams app to manage itself and its permission grants in teams |
...
| Display name | - | Manage user's installed Teams apps |
...
| Display name | - | Allow the Teams app to manage itself in chats |
...
| Display name | - | Allow the app to manage itself in teams |
...
| Display name | - | Allow the Teams app to manage itself for a user |
...
| Display name | Read all teams' settings | Read teams' settings |
...
| Display name | Read and change all teams' settings | Read and change teams' settings |
...
| Display name | Create tabs in Microsoft Teams. | Create tabs in Microsoft Teams. |
...
| Display name | Read tabs in Microsoft Teams. | Read tabs in Microsoft Teams. |
...
| Display name | Read and write tabs in Microsoft Teams. | Read and write tabs in Microsoft Teams. |
...
| Display name | - | Allow the Teams app to manage all tabs in chats |
...
| Display name | - | Allow the Teams app to manage all tabs in teams |
...
| Display name | - | Allow the Teams app to manage all tabs for a user |
...
| Display name | - | Allow the Teams app to manage only its own tabs in chats |
...
| Display name | - | Allow the Teams app to manage only its own tabs in teams |
...
| Display name | - | Allow the Teams app to manage only its own tabs for a user |
...
| Display name | - | Read available Teams templates |
...
| Display name | Read Teams app settings | Read Teams app settings |
...
| Display name | Read and write Teams app settings | Read and write Teams app settings |
...
| Display name | Read Teams devices | Read Teams devices |
...
| Display name | Read and write Teams devices | Read and write Teams devices |
...
| Display name | Read all term store data | Read term store data |
...
| Display name | Read and write all term store data | Read and write term store data |
...
| Display name | - | Read and write threat assessment requests |
...
| Display name | Run hunting queries | Run hunting queries |
...
| Display name | Read all threat indicators | Read all threat indicators |
...
| Display name | Manage threat indicators this app creates or owns | Manage threat indicators this app creates or owns |
...
| Display name | Read all Threat Intelligence Information | Read all threat intelligence information |
...
| Display name | - | Read threat submissions |
...
| Display name | Read all of the organization's threat submissions | Read all threat submissions |
...
| Display name | - | Read and write threat submissions |
...
| Display name | Read and write all of the organization's threat submissions | Read and write all threat submissions |
...
| Display name | Read and write all of the organization's threat submission policies | Read and write all threat submission policies |
...
| Display name | Read trust framework key sets | Read trust framework key sets |
...
| Display name | Read and write trust framework key sets | Read and write trust framework key sets |
...
| Display name | - | Read unified group memberships as guest |
...
| Display name | Enable and disable user accounts | Enable and disable user accounts |
...
| Display name | Export user's data | Export user's data |
...
| Display name | Invite guest users to the organization | Invite guest users to the organization |
...
| Display name | Manage all users' identities | Manage  user identities |
...
| Display name | - | Sign in and read user profile |
...
| Display name | Read all users' full profiles | Read all users' full profiles |
...
| Display name | - | Read and write access to user profile |
...
| Display name | Read and write all users' full profiles | Read and write all users' full profiles |
...
| Display name | - | Read and write app activity to users' activity feed |
...
| Display name | - | Read user authentication methods. |
...
| Display name |  Read all users' authentication methods | Read all users' authentication methods |
...
| Display name | - | Read and write user authentication methods |
...
| Display name | Read and write all users' authentication methods  | Read and write all users' authentication methods. |
...
| Display name | Read all users' lifecycle information | Read all users' lifecycle information |
...
| Display name | Read and write all users' lifecycle information | Read and write all users' lifecycle information |
...
| Display name | Deliver and manage all user's notifications | Deliver and manage user's notifications |
...
| Display name | - | Write app activity to users' timeline |
...
| Display name | - | Read a user's virtual appointments |
...
| Display name | Read all virtual appointments for users, as authorized by online meetings application access policy | - |
...
| Display name | - | Read and write a user's virtual appointments   |
...
| Display name | - | Read your virtual events |
...
| Display name | Read and write all Windows update deployment settings | Read and write all Windows update deployment settings |
...
| Display name | - | Read workforce integrations |
...
| Display name | Read and write workforce integrations | Read and write workforce integrations |
